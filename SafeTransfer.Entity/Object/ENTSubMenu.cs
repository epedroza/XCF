...
namespace SafeTransfer.Entity.Object
{
	...
	public class ENTSubMenu : ENTBase
	{
      ...
      private Int32  _idCompany;       // Identificador único de la Compañía al que pertenece el usuario que consulta el listado de SubMenús
      ...
      ///<remarks>
      ///   <name>ENTMenu.idCompany</name>
      ///   <create>21-Octubre-2013</create>
      ///   <author>GCSoft - Web Project Creator BETA 1.0</author>
      ///</remarks>
      ///<summary>Obtiene/Asigna el identificador único de la Compañía al que pertenece el usuario que consulta el listado de SubMenús</summary>
