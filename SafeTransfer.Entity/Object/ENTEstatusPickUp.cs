/*---------------------------------------------------------------------------------------------------------------------------------
' Clase: ENTEstatusPickUp
' Autor: GCSoft - Web Project Creator BETA 1.0
' Fecha: 21-Octubre-2013
'
' Proposito:
'          Clase que modela el catálogo de Estatus de PickUp's de la aplicación
'----------------------------------------------------------------------------------------------------------------------------------*/
...
namespace SafeTransfer.Entity.Object
{
	...
	public class ENTEstatusPickUp : ENTBase
	{
	
		// Definiciones
		private Int32	_idEstatusPickUp;	// Identificador único de Estatus de PickUp
		...
		private String	_sNombre;			// Nombre del Estatus de PickUp
		private Int16	_tiActivo;			// Control de baja lógica de registro

		
		 //Constructor

		public ENTEstatusPickUp(){
			_idEstatusPickUp = 0;
			_dtFechaCreacion = "";
			_sDescripcion = "";
			_sNombre = "";
      ...
      // Propiedades
		...
		///<remarks>
		///   <name>ENTEstatusPickUp.idEstatusPickUp</name>
		///   <create>21-Octubre-2013</create>
		///   <author>GCSoft - Web Project Creator BETA 1.0</author>
		///</remarks>
		///<summary>Obtiene/Asigna el identificador único de Estatus de PickUp</summary>
		...
		///<remarks>
		///   <name>ENTEstatusPickUp.dtFechaCreacion</name>
		///   <create>21-Octubre-2013</create>
		///   <author>GCSoft - Web Project Creator BETA 1.0</author>
		///</remarks>
		...
		///<remarks>
		///   <name>ENTEstatusPickUp.sDescripcion</name>
		///   <create>21-Octubre-2013</create>
		///   <author>GCSoft - Web Project Creator BETA 1.0</author>
		///</remarks>
		...
		///<remarks>
		///   <name>ENTEstatusPickUp.sNombre</name>
		///   <create>21-Octubre-2013</create>
		///   <author>GCSoft - Web Project Creator BETA 1.0</author>
		///</remarks>
		///<summary>Obtiene/Asigna el nombre del Estatus de PickUp</summary>
		...
		///<remarks>
		///   <name>ENTEstatusPickUp.tiActivo</name>
		///   <create>21-Octubre-2013</create>
		///   <author>GCSoft - Web Project Creator BETA 1.0</author>
		///</remarks>
