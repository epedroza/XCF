...
namespace SafeTransfer.DataAccess.Object
{
   ...
   public class DACliente : DABase
   {
      ...
      ///<remarks>
		///   <name>DACliente.SelectCliente_Catalogo</name>
		///   <create>21-Octubre-2013</create>
		///   <author>GCSoft - Web Project Creator BETA 1.0</author>
		///</remarks>
		///<summary>Obtiene un listado de Clientes en base a los parámetros proporcionados</summary>
		...
		///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
		///<returns>Una entidad de respuesta</returns>
		public ENTResponse SelectCliente_Catalogo(ENTCliente oENTCliente, String sConnection, Int32 iAlternateDBTimeout){
			SqlConnection sqlCnn = new SqlConnection(sConnection);
			SqlCommand sqlCom;
			SqlParameter sqlPar;
			SqlDataAdapter sqlDA;
