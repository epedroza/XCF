<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="scatUsuario.aspx.cs" Inherits="SafeTransfer.Web.Application.WebApp.Private.SysCat.scatUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
         ...
         <td>
            <asp:Panel id="pnlGrid" runat="server" Width="100%">
               <asp:GridView id="gvUsuario" runat="server" border="0" AllowPaging="false" AllowSorting="true" AutoGenerateColumns="False" Width="790px"
						DataKeyNames="idUsuario, idCompany, tiActivo, sFullName"
						...
						<Columns>
                     <asp:BoundField HeaderText="Compañía"           ItemStyle-HorizontalAlign="Left"    ItemStyle-Width="150px" DataField="sCompany"    SortExpression="sCompany"></asp:BoundField>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="height:100%; text-align:left;" width="100%">
                           <tr style="height:20px;"><td colspan="3"></td></tr>
                            <tr class="trFilaItem">
									   ...
									   <td style="width:5px;"></td>
									   <td><asp:DropDownList id="ddlActionCompany" runat="server" CssClass="DropDownList_General" width="316px" AutoPostBack="True" onselectedindexchanged="ddlActionCompany_SelectedIndexChanged" ></asp:DropDownList></td>
								   </tr>
								   <tr style="height:5px;"><td colspan="3"></td></tr>
                           <tr class="trFilaItem">
									   <td class="tdActionCeldaLeyendaItem">&nbsp;Rol</td>
									   <td style="width:5px;"></td>
									   <td><asp:DropDownList id="ddlActionRol" runat="server" CssClass="DropDownList_General" width="316px" ></asp:DropDownList></td>
								   </tr>
								   <tr style="height:5px;"><td colspan="3"></td></tr>
                           <tr class="trFilaItem">
   ...
   <asp:HiddenField ID="hddSort" runat="server" value="sCompany" />
</asp:Content>
