<%@ Page Language="C#" MasterPageFile="~/Include/MasterPage/LoginTemplate.Master" AutoEventWireup="true" CodeBehind="frmLogin.aspx.cs" Inherits="SafeTransfer.Web.Application.WebApp.frmLogin" Title="SafeTransfer - Autenticación de Usuario" %>
