   ...
   public partial class scatRol : BPPage
   {
      ...
      private void InsertRol(){
         ...
         DataRow rowSelected;
            ...
            // Formulario
            oENTRol.idCompany = Int32.Parse(this.ddlActionCompany.SelectedValue);
            ...
            // Mensaje de usuario
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "tinyboxMessage('Rol creado con éxito!', 'Success', true); focusControl('" + (this.ddlCompany.Enabled ? this.ddlCompany.ClientID : this.txtNombre.ClientID) + "');", true);
      ...
      private void SelectSubMenu_ForViewState(){
         ...
         DataRow rowSubMenu = null;
            ...
            // Seguridad
            oENTSession = (ENTSession)this.Session["oENTSession"];
            oENTSubMenu.idCompany = oENTSession.idCompany;
      ...
      private void SetPanel(RolActionTypes RolActionType, Int32 idItem = 0){
         try
         {
            ...
            // Foco
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "focusControl('" + (this.ddlActionCompany.Enabled ? this.ddlActionCompany.ClientID : this.txtActionNombre.ClientID) + "');", true);
      ...
      private void UpdateRol(Int32 idRol){
         ...
         DataRow rowSelected;
            ...
            // Mensaje de usuario
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "tinyboxMessage('Rol actualizado con éxito!', 'Success', true); focusControl('" + (this.ddlCompany.Enabled ? this.ddlCompany.ClientID : this.txtNombre.ClientID) + "');", true);
      ...
      private void ValidateActionForm(){
         try
         {
            ...
            // No es posible crear Roles para la Compañía Master
            if (this.ddlActionCompany.SelectedValue == "1") { throw new Exception("* Por el momento no es posible crear Roles para GCSoft"); }
      ...
      protected void gvActionSubMenu_RowDataBound(object sender, GridViewRowEventArgs e){
         ...
         // Seguridad
         if (idSubMenu == "1" || idSubMenu == "2" || idSubMenu == "3"){ oCheckBox.Checked = false; oCheckBox.Enabled = false; }
      ...
      protected void gvRol_RowDataBound(object sender, GridViewRowEventArgs e){
         ...
         String sTootlTip = "";
            ...
            idCompany = this.gvRol.DataKeys[e.Row.RowIndex]["idCompany"].ToString();
