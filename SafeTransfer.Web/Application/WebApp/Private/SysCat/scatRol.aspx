<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="scatRol.aspx.cs" Inherits="SafeTransfer.Web.Application.WebApp.Private.SysCat.scatRol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
         ...
         <td>
            <asp:Panel id="pnlGrid" runat="server" Width="100%">
               <asp:GridView id="gvRol" runat="server" AllowPaging="false" AllowSorting="true" AutoGenerateColumns="False" Width="790px"
						DataKeyNames="idRol, idCompany, tiActivo, sNombre"
						...
						<EmptyDataTemplate>
                           ...
                           <td style="width:150px;">Compañía</td>
									<td style="width:150px;">Nombre del Rol</td>
									<td style="width:430px;">Descripción</td>
                           <td style="width:100px;">Estatus</td>
								</tr>
								<tr class="Grid_Row">
									<td colspan="4">No se encontraron Roles registrados en el sistema</td>
								</tr>
							</table>
						</EmptyDataTemplate>
						<Columns>
                     <asp:BoundField HeaderText="Compañía"        ItemStyle-HorizontalAlign="Left"    ItemStyle-Width="150px" DataField="sNombreCompany" SortExpression="sNombreCompany"></asp:BoundField>
							<asp:BoundField HeaderText="Nombre del Rol"	ItemStyle-HorizontalAlign="Left"    ItemStyle-Width="150px" DataField="sNombre"        SortExpression="sNombre"></asp:BoundField>
							<asp:BoundField HeaderText="Descripción"		ItemStyle-HorizontalAlign="Left"		ItemStyle-Width="350px" DataField="sDescripcion"	SortExpression="sDescripcion"></asp:BoundField>
   ...
   <asp:HiddenField ID="hddSort" runat="server" value="sNombreCompany" />
