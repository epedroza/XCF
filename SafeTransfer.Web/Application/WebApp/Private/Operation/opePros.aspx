...
<%@ Register src="../../../../Include/WebUserControls/wucTimeMask.ascx" tagname="TimeMask" tagprefix="wuc" %>
                            ...
                            <td colspan="15">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr class="trFilaItem">
                                        ...
                                        <td class="tdCeldaItemBrown" colspan="4"><asp:TextBox ID="txtNombreOrigen" runat="server" CssClass="Textbox_General_16" width="280px" Enabled="False" ></asp:TextBox></td>
                                        ...
                                        <td class="tdCeldaItemPurple" colspan="4"><asp:TextBox ID="txtNombreDestino" runat="server" CssClass="Textbox_General_16" width="230px" Enabled="False" ></asp:TextBox></td>
                                        <td class="tdCeldaItem">&nbsp;</td>
						            </tr> 
                                    <tr class="trFilaItem">
                                    ...
                                    <tr class="trFilaItem">
                                        ...
                                        <td class="tdCeldaItemBrown" colspan="6"><asp:TextBox ID="txtProExterno" runat="server" CssClass="Textbox_General_16" width="100px" ></asp:TextBox></td>
                                    ...
                                    <tr class="trFilaItem">
                                        ...
                                        <td class="tdCeldaItemGray2" colspan="4"><asp:TextBox ID="txtNombreCFiscal" runat="server" 
                                                CssClass="Textbox_General_16" width="280px" Enabled="False" ></asp:TextBox></td>
                                        ...
                                        <td class="tdCeldaItemGreen" colspan="4"><asp:TextBox ID="txtNombreAAduanal" runat="server" 
                                                CssClass="Textbox_General_16" width="230px" Enabled="False" ></asp:TextBox></td>
                                        <td class="tdCeldaItem">&nbsp;</td>
						            </tr>
                                    <tr class="trFilaItem">
                        ...
                        <tr class="trFilaItem">
                            ...
                            <td class="tdCeldaItem" colspan="3">&nbsp;
                                <table>
                                    ...
                                    <tr>
                                        <td class="tdCeldaItem" colspan="2"><asp:TextBox ID="txtValorMercancia" runat="server" CssClass="Textbox_General_16" width="100px" ></asp:TextBox></td>
                                    </tr>
                                    <tr>
         ...
         <td>
            <asp:Panel id="pnlBotones" runat="server" Width="100%">
               <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr><td class="tdCeldaMiddleSpace">
                      <asp:TextBox ID="txtObervaciones" runat="server" Height="70px" Width="532px" 
                          TextMode="MultiLine"></asp:TextBox>
                    </td>
                    <td class="tdCeldaMiddleSpace"></td>
                  </tr>
                  <tr>
                     <td style="height:24px; text-align:left; width:130px;"><asp:Button ID="btnBuscar" runat="server" Text="Buscar" CssClass="Button_General" width="125px" />
                         &nbsp; <asp:Button ID="btnNuevo" runat="server" Text="Nuevo" CssClass="Button_General" width="125px" />
                         &nbsp; <asp:Button ID="cmdGuardar" runat="server" CssClass="Button_General" Text="Guardar" width="125px" onclick="cmdGuardar_Click" /></td>
