...
namespace SafeTransfere.Web.Application.WebApp.Private.Operation
{
   public partial class opeManifiestosMonitor : System.Web.UI.Page
   {
       ...
       void FillGrid()
       {
           ...
           {
               ent.FechaSalida = System.DateTime.Parse(wucFechaInicial.BeginDate);
               ent.FechaLlegada = System.DateTime.Parse(wucFechaInicial.EndDate);
           }
           else
           {
               ent.FechaSalida = System.DateTime.Parse("1900-01-01");
               ent.FechaLlegada = System.DateTime.Parse("1900-01-01");
           }
