   ...
   public class BPUsuario : BPBase
   {
      ...
      ///<returns>Una entidad de respuesta</returns>
		public ENTResponse InsertUsuario(ENTUsuario oENTUsuario){
         ...
         String sPassword = "";
            ...
            "<html>" +
               "<head>" +
                  "<title>SafeTransfer - Bienvenido al sistema</title>" +
               "</head>" +
                  ...
                  "<div style='clear:both; height:90%; text-align:center; width:100%;'>" +
                     "<div style='height:80%; clear: both; margin:0px auto; position:relative; top:10%; width:90%;'>" +
                        "<table border='0px;' cellpadding='0' cellspacing='0' style='height:100%; width:100%;'>" +
                           "<tr>" +
                              "<td colspan='2' valign='middle' style='color:#549CC6; font-family:Arial; font-size:12px; font-weight:bold; text-align:left;'>SafeTransfer - Recuperación de contraseña</td>" +
                           "</tr>" +
                           ...
                           "<tr>" +
                              "<td colspan='2' valign='top' style='font-family:Arial; font-size:12px;'>" +
                                 "El equipo de Logística le da la bienvenida al sistema de SafeTransfer. Los datos de acceso a la aplicación son los siguientes<br><br>" +
            ...
            "</html>";
				...
				// Enviar correo
            utilMail.SendMail("SafeTransfer - Bienvenido al sistema", oENTUsuario.sEmail, "SafeTransfer - Bienvenido al sistema", sHTMLMessage);
      ...
      public ENTResponse SelectUsuario_Autenticacion(ENTUsuario oENTUsuario){
         ...
         HttpContext oContext;
            ...
            oENTSession.idCompany = int.Parse(oENTResponse.dsResponse.Tables[1].Rows[0]["idCompany"].ToString());
      ...
      public ENTResponse SelectUsuario_RecuperaContrasena(ENTUsuario oENTUsuario){
         ...
         try
         {
            ...
            sHTMLMessage = "" +
               "<html>" +
               "<head>" +
                  "<title>SafeTransfer - Recuperación de contraseña</title>" +
               "</head>" +
               "<body style='height:100%; margin:0px; padding:0px; width:100%;'>" +
                  "<div style='clear:both; height:90%; text-align:center; width:100%;'>" +
                     "<div style='height:80%; clear: both; margin:0px auto; position:relative; top:10%; width:90%;'>" +
                        "<table border='0px;' cellpadding='0' cellspacing='0' style='height:100%; width:100%;'>" +
                           ...
                           "<tr>" +
                              "<td colspan='2' valign='top' style='font-family:Arial; font-size:12px;'>" +
                                 "Usted ha solicitado información de usuario al sistema SafeTransfer. Los datos de acceso a la aplicación son los siguientes<br><br>" +
                                 "<table border='0px' cellpadding='0' cellspacing ='0' class='Text' style='height:100%; width:100%'>" +
                                    "<tr style='height:10px'><td></td></tr>" +
                                    "<tr>" +
                                       "<td style='text-align:left;'>" +
            ...
            // Enviar correo
            utilMail.SendMail("SafeTransfer - Recuperación de contraseña", oENTUsuario.sEmail, "SafeTransfer - Recuperación de contraseña", sHTMLMessage);
