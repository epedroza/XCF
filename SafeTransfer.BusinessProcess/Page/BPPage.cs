...
namespace SafeTransfer.BusinessProcess.Page
{
      ...
      protected void Override_PagePreLoad(object sender, EventArgs e){
         ...
         if (sPage != "AppIndex.aspx" && sPage != "saLogout.aspx" && sPage != "saNotificacion.aspx"){
            ...
            if ( oENTSession.idCompany != 1 ){
               if (oDACompany.IsCompanyActive(oENTSession.idCompany, ConfigurationManager.ConnectionStrings["Application.DBCnn"].ToString(), 0) == false){
         ...
         if ((sPage == "scatCompany.aspx" || sPage == "scatMenu.aspx" || sPage == "scatSubMenu.aspx") && (oENTSession.idCompany != 1) ){
